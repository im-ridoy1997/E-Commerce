...
@section('page_title','Edit Privacy')
...
<div class="card aos-init aos-animate mt-4"  data-aos="fade-up" data-aos-delay="800">
    ...
    <div class="card-body">
    <div class="example">
        <form method="post" action="{{ url('admin/privacy/update') }}" enctype="multipart/form-data">
            @csrf
            <div class="mb-3 col-6">
                <label for="exampleInputEmail1" class="form-label">Text</label>
                <textarea class="form-control" name="name" id="exampleFormControlTextarea1" rows="8">{{ $privacy->name }}</textarea>
            </div>
